...
| [`design_paddle_tennis.md`](design_paddle_tennis.md) | **Proposed** (not implemented) | v0.25.0, 2026-08-02 | PaddleTennis, the missing rung between wall-ball and humanoid tennis: 1v1 rally play on the full court with the calibrated paddles, scripted-oracle then frozen-champion opponents, cooperative rally before scoring, and the pre-committed P0–P5 probe battery that must run before any env code ships. |
...
| [`paddle_tennis_probes_p3_p4_20260802.md`](paddle_tennis_probes_p3_p4_20260802.md) | Review snapshot | committed prototype, post-0.25.0, 2026-08-02 | P3–P4 results on the committed paddle-court prototype: the serve band is measured (origin 3.25 m, 9 m/s, 21–24° — 78% legal, 4.7–5.0 m deep, 100% returnable; origin 2.0 m disqualified by server self-touch), alternation is exactly fair (36/36 mirrored cell pairs identical), and P4's mirroring identity passes bit-for-bit on observations with sign-exact action mirroring. P5 (champion transfer) stays open. |
